...
class Social_classifier:
    #default model path
    default_embed_model_path = '/home/kist/catkin_ws/src/hnna_pkg_test/scripts/social_dialog_strategy_classifier/models/default_models/deeptask_Sentence2vector_0_5_100_200'
    default_cls_model_path = '/home/kist/catkin_ws/src/hnna_pkg_test/scripts/social_dialog_strategy_classifier/models/default_models/clf_NaiveBayes.model'
    # default_embed_model_path = os.getcwd()+'/../../models/default_models/deeptask_Sentence2vector_0_5_100_200'
    # default_cls_model_path = os.getcwd()+'/../../models/default_models/clf_NaiveBayes.model'
